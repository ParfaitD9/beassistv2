...
if __name__ == '__main__':
    ...
    if args.cmd == 'install':
        ...
        print("Étape 4/ : Vérification du fichier de configuration ...")
        ...
        print("Étape 5/ : Création des répertoires importants ...")
        try:
        ...
        print("Étape 6/ : Mise en place de la base de données ...")
